...
import com.dici.latexEditor.properties.LanguageProperties;
...
public class Settings {
	...
	private static void loadProperties() {
		try (InputStreamReader isr = new InputStreamReader(
		        ConfigProperties.class.getResourceAsStream("config.properties"))) {
			properties.load(isr);
			isr.close();
		} catch (IOException e) {
    ...
    private static void loadLocalizedTexts(String lang) {
        try (InputStreamReader isr = new InputStreamReader(LanguageProperties.class.getResourceAsStream(lang))) {
			strings.load(isr);
			isr.close();
		} catch (IOException e) {
